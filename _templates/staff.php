...
<div class="main_content">
	...
	<?php while($testimonial = mysql_fetch_assoc($get_testimonials)) { ?>
		<div class="staff_item">
        	<?php if($testimonial['content_image_1']) { ?> <div class="border8 left"><img class="border8" src="<?php echo $_IMAGE_FOLDERS['about_staff90x130'] . $testimonial['content_image_1'];?>"/></div><?php }?>
            <div class="right staff_content">
                <div class="name"><?php echo $testimonial['content_title']?></div>
                <div class="title"><?php echo $testimonial['content_title_2']?></div>
