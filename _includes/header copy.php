...
<?php nav($urlPath_array[0]); ?>
		...
		<div id="searchbox" class="right">
			<form method="get" id="searchform" action="/blog/">
				<input class="border18" type="text" value="Search Thirsties" onfocus="if (this.value == 'Search Thirsties') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search Thirsties';}" name="s" id="s" />
			</form>
		</div><!--END #searchbox-->
	</header><!--END #header-->